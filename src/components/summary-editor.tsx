    ...
    <Card className="text-sm">
      ...
      <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex items-center gap-2 rounded-full border border-neutral-200 bg-neutral-50 px-2 py-1 dark:border-neutral-700 dark:bg-neutral-900/40">
            ...
            <input
              ...
              className="h-0.5 w-24 accent-neutral-700 dark:accent-neutral-300"
      ...
      <div className="mt-3 space-y-2">
        ...
        <div className="rounded-md border border-neutral-200 bg-white p-2.5 dark:border-neutral-700 dark:bg-neutral-950">
          <p className="text-xs font-medium text-neutral-700 dark:text-neutral-300">Agent chat</p>
        ...
        <div>
          ...
          <p className="mt-1 rounded-md border border-transparent bg-neutral-50 px-2.5 py-2 text-sm text-neutral-700 dark:bg-neutral-900/50 dark:text-neutral-300">
